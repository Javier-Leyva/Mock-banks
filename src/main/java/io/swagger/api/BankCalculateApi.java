...
@Validated
@Api(value = "bank_calculate", description = "the bank_calculate API")
@RequestMapping(value = "/banks")
public interface BankCalculateApi {

    @ApiOperation(value = "This functionality allows to have the information of the BIC Code bank according to a contract input and his basic information.", nickname = "bankCalculateGet", notes = "This functionality allows to obtain from a contract, in two diferent formats, the information associated to the bank in BIC code format. The information associated to the BIC code is the neme of the bank and his postal address. Also provided the local bank code and the branch code associared to the contract in the input. Not always exist the local branch in all the contracts of the different countries, p.e. countries USA, Austria, Germany...", response = GetBankCalculateResponse.class, authorizations = {
        @Authorization(value = "JWT Profile", scopes = {
            @AuthorizationScope(scope = "bankbranch.read", description = "Banks Branches scope")
            })
    }, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = GetBankCalculateResponse.class),

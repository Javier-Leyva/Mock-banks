...
import io.swagger.model.GetBankCalculateResponse;
...
@Controller
public class BankCalculateApiController implements BankCalculateApi {

    private static final Logger log = LoggerFactory.getLogger(BankCalculateApiController.class);

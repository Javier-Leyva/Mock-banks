...
public interface DefaultApi {
    ...
    @ApiOperation(value = "Obtains customer banks status information.", nickname = "rootGet", notes = "This feature returns the status information of the connection with each bank that the customer previously connected. With that information the user can ask for the Global Position of the bank.", response = GetBankArrayResponse.class, authorizations = {
        @Authorization(value = "JWT Profile", scopes = {
            @AuthorizationScope(scope = "bankbranch.read", description = "Banks Branches scope")
            })
    }, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = GetBankArrayResponse.class),
